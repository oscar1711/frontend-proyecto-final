...
const AgregarProductos = () => {
    ...
    useEffect(() => {
        document.getElementById("dimesiones").focus();
    }, [])
    ...
    const CrearProducto = async () => {
        const data = {
            dimesiones: productos.dimesiones,
            peso: productos.peso,
            precio: productos.precio,
            origen: productos.origen,
            destino: productos.destino
        }
        const response = await APIInvoke.invokePOST('/api/producto', data);
